...
def test_save_images_from_cameras(tmp_path, request, camera_type, mock):
    ...
    if camera_type == "opencv":
        from lerobot.lerobot.common.robot_devices.cameras.opencv import save_images_from_cameras
    elif camera_type == "intelrealsense":
        from lerobot.lerobot.common.robot_devices.cameras.intelrealsense import save_images_from_cameras
