...
from lerobot.lerobot.common.robot_devices.utils import (
    RobotDeviceAlreadyConnectedError,
    RobotDeviceNotConnectedError,
    busy_wait,
)
from lerobot.lerobot.common.utils.utils import capture_timestamp_utc
...
def save_images_from_cameras(
    ...
    for cam_idx in camera_ids:
        ...
        config = OpenCVCameraConfig(camera_index=cam_idx, fps=fps, width=width, height=height, color_mode=color_mode, mock=mock)
