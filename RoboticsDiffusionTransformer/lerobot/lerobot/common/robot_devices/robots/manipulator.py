...
from lerobot.lerobot.common.robot_devices.cameras.utils import make_cameras_from_configs
from lerobot.lerobot.common.robot_devices.motors.utils import MotorsBus, make_motors_buses_from_configs
from lerobot.lerobot.common.robot_devices.robots.configs import ManipulatorRobotConfig
from lerobot.lerobot.common.robot_devices.robots.utils import get_arm_id
from lerobot.lerobot.common.robot_devices.utils import RobotDeviceAlreadyConnectedError, RobotDeviceNotConnectedError
...
class ManipulatorRobot:
    ...
    def connect(self):
        ...
        if self.robot_type not in ["so101_leader"]:
            for name in self.follower_arms :
            ...
            if self.robot_type in ["koch", "koch_bimanual", "aloha"]:
                from lerobot.lerobot.common.robot_devices.motors.dynamixel import TorqueMode
            ...
            # self.activate_calibration() # 单臂不用calibration

            # Set robot preset (e.g. torque in leader gripper for Koch v1.1) - 没有follower
    ...
    def activate_calibration(self):
        ...
        def load_or_run_calibration_(name, arm, arm_type):
            ...
            # tmp change
            arm_path = Path(__file__).resolve().parent.parent.parent.parent.parent
            arm_calib_path = arm_path / self.calibration_dir / f"{arm_id}.json"
            if arm_calib_path.exists():
                ...
                if self.robot_type in ["koch", "koch_bimanual", "aloha"]:
                    from lerobot.lerobot.common.robot_devices.robots.dynamixel_calibration import run_arm_calibration

                    calibration = run_arm_calibration(arm, self.robot_type, name, arm_type)

                elif self.robot_type in ["so100", "so101", "moss", "lekiwi"]:
                    from lerobot.lerobot.common.robot_devices.robots.feetech_calibration import (
    ...
    def teleop_step(
        ...
        for name in self.follower_arms:
            ...
            self.logs[f"write_sim_{name}_goal_pos_dt_s"] = time.perf_counter() - before_fwrite_t
