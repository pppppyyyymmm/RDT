...
def get_motor_bus_cls(brand: str) -> tuple:
    if brand == "feetech":
        from lerobot.lerobot.common.robot_devices.motors.configs import FeetechMotorsBusConfig
        from lerobot.lerobot.common.robot_devices.motors.feetech import (
        ...
        from lerobot.lerobot.common.robot_devices.motors.dynamixel import (
            MODEL_BAUDRATE_TABLE,
